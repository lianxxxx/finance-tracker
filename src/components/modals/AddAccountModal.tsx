    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      peer-not-placeholder-shown:-top-2 peer-not-placeholder-shown:text-xs"
        ...
        <div className="flex gap-3 px-6 pt-4 pb-6 shrink-0">
          ...
          <button
            onClick={onClose}
            className="flex-1 text-slate-800 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 text-sm font-medium py-2.5 rounded-xl transition-colors border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-800 cursor-pointer bg-slate-100"
          >
            Discard
          </button>
        </div>
