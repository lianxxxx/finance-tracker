...
export default function MobileNav() {
  ...
  return (
    <div>
      {/* ===== MOBILE TOP HEADER ===== */}
      <header className="md:hidden fixed top-4 left-4 right-4 z-40 flex items-center justify-between px-4 pt-4 pb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center bg-slate-800 rounded-full p-1 gap-0.5">
            <button className="flex items-center justify-center w-7 h-7 rounded-full bg-slate-700 text-amber-400 transition-all">
              <MdOutlineWbSunny size={14} />
            </button>
            <button className="flex items-center justify-center w-7 h-7 rounded-full text-slate-500 transition-all">
      ...
      {/* ===== MOBILE BOTTOM NAV ===== */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 dark:bg-slate-900 dark:border-slate-800 flex justify-around pt-4 pb-6 px-4">
